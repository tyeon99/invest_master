<template>
  <div
    ...
    :class="{ 'animate__fadeIn': isOffcanvasAni, 'animate__fadeOut': !isOffcanvasAni }" @click="closeOrderCmpOffcanvas">
    <div
    ...
    >
      ...
      <div class="offcanvas-footer">
        <button @click="closeOrderCmpOffcanvas">확 인</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    closeOrderCmpOffcanvas() {
      this.$emit('close-orderCmpOffcanvas')
    }
  }
}
</script>
...
.offcanvas-body{
  @apply w-full h-[80px] rounded-[12px] bg-[#f2f9fa] flex justify-center items-center mb-[40px] font-semibold text-[14px] leading-[16px] text-center text-[#00A6BD];
}
.offcanvas-body span{
